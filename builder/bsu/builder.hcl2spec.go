...
import (
	...
	"github.com/numspot/numspot-plugin-packer/builder/common"
...
type FlatConfig struct {
	...
	ImageAccountIDs             []string                               `mapstructure:"image_account_ids" required:"false" cty:"image_account_ids" hcl:"image_account_ids"`
	ImageGroups                 []string                               `mapstructure:"image_groups" required:"false" cty:"image_groups" hcl:"image_groups"`
	ImageRegions                []string                               `mapstructure:"image_regions" required:"false" cty:"image_regions" hcl:"image_regions"`
	ImageBootModes              []string                               `mapstructure:"image_boot_modes" required:"false" cty:"image_boot_modes" hcl:"image_boot_modes"`
	...
	Tags                        common.TagMap                          `mapstructure:"tags" required:"false" cty:"tags" hcl:"tags"`
	ForceDeregister             *bool                                  `mapstructure:"force_deregister" required:"false" cty:"force_deregister" hcl:"force_deregister"`
	ForceDeleteSnapshot         *bool                                  `mapstructure:"force_delete_snapshot" required:"false" cty:"force_delete_snapshot" hcl:"force_delete_snapshot"`
	SnapshotTags                common.TagMap                          `mapstructure:"snapshot_tags" required:"false" cty:"snapshot_tags" hcl:"snapshot_tags"`
	SnapshotAccountIDs          []string                               `mapstructure:"snapshot_account_ids" required:"false" cty:"snapshot_account_ids" hcl:"snapshot_account_ids"`
	GlobalPermission            *bool                                  `mapstructure:"global_permission" required:"false" cty:"global_permission" hcl:"global_permission"`
	RootDeviceName              *string                                `mapstructure:"root_device_name" required:"false" cty:"root_device_name" hcl:"root_device_name"`
	ImageMappings               []common.FlatBlockDevice               `mapstructure:"image_block_device_mappings" cty:"image_block_device_mappings" hcl:"image_block_device_mappings"`
	...
	DisableStopVM               *bool                                  `mapstructure:"disable_stop_vm" required:"false" cty:"disable_stop_vm" hcl:"disable_stop_vm"`
	BsuOptimized                *bool                                  `mapstructure:"bsu_optimized" required:"false" cty:"bsu_optimized" hcl:"bsu_optimized"`
	EnableT2Unlimited           *bool                                  `mapstructure:"enable_t2_unlimited" required:"false" cty:"enable_t2_unlimited" hcl:"enable_t2_unlimited"`
	IamVMProfile                *string                                `mapstructure:"iam_vm_profile" required:"false" cty:"iam_vm_profile" hcl:"iam_vm_profile"`
	VMInitiatedShutdownBehavior *string                                `mapstructure:"shutdown_behavior" required:"false" cty:"shutdown_behavior" hcl:"shutdown_behavior"`
	...
	SourceImageFilter           *common.FlatImageFilterOptions         `mapstructure:"source_image_filter" required:"false" cty:"source_image_filter" hcl:"source_image_filter"`
	...
	TemporarySGSourceCidr       *string                                `mapstructure:"temporary_security_group_source_cidr" required:"false" cty:"temporary_security_group_source_cidr" hcl:"temporary_security_group_source_cidr"`
	UserData                    *string                                `mapstructure:"user_data" required:"false" cty:"user_data" hcl:"user_data"`
	UserDataFile                *string                                `mapstructure:"user_data_file" required:"false" cty:"user_data_file" hcl:"user_data_file"`
	NetFilter                   *common.FlatNetFilterOptions           `mapstructure:"net_filter" required:"false" cty:"net_filter" hcl:"net_filter"`
	NetID                       *string                                `mapstructure:"net_id" required:"false" cty:"net_id" hcl:"net_id"`
	...
	VolumeRunTags               common.TagMap                          `mapstructure:"run_volume_tags" required:"false" cty:"run_volume_tags" hcl:"run_volume_tags"`
...
func (*FlatConfig) HCL2Spec() map[string]hcldec.Spec {
	s := map[string]hcldec.Spec{
		...
		"image_account_ids":                    &hcldec.AttrSpec{Name: "image_account_ids", Type: cty.List(cty.String), Required: false},
		"image_groups":                         &hcldec.AttrSpec{Name: "image_groups", Type: cty.List(cty.String), Required: false},
		"image_regions":                        &hcldec.AttrSpec{Name: "image_regions", Type: cty.List(cty.String), Required: false},
		"image_boot_modes":                     &hcldec.AttrSpec{Name: "image_boot_modes", Type: cty.List(cty.String), Required: false},
		...
		"image_block_device_mappings":          &hcldec.BlockListSpec{TypeName: "image_block_device_mappings", Nested: hcldec.ObjectSpec((*common.FlatBlockDevice)(nil).HCL2Spec())},
		...
		"source_image_filter":                  &hcldec.BlockSpec{TypeName: "source_image_filter", Nested: hcldec.ObjectSpec((*common.FlatImageFilterOptions)(nil).HCL2Spec())},
