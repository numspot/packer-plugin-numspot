...
var (
	...
	ErrRetryExhausted error = errors.New("function never succeeded in Retry")
	// ErrRetryInvalidIntervals is returned when retry intervals are invalid.
	ErrRetryInvalidIntervals = errors.New(
		"invalid retry intervals (negative or initial < max)",
	)
)
